...
public enum Position {
  ...
  A1R(Colour.WHITE, 0, 0), A2R(Colour.WHITE, 1, 0), A3R(Colour.WHITE, 2, 0), A4R(Colour.WHITE, 3, 0),
  A5R(Colour.WHITE, 4, 0), A6R(Colour.WHITE, 5, 0), A7R(Colour.WHITE, 6, 0), A8R(Colour.WHITE, 7, 0),
  B1R(Colour.WHITE, 0, 1), B2R(Colour.WHITE, 1, 1), B3R(Colour.WHITE, 2, 1), B4R(Colour.WHITE, 3, 1),
  B5R(Colour.WHITE, 4, 1), B6R(Colour.WHITE, 5, 1), B7R(Colour.WHITE, 6, 1), B8R(Colour.WHITE, 7, 1),
  C1R(Colour.WHITE, 0, 2), C2R(Colour.WHITE, 1, 2), C3R(Colour.WHITE, 2, 2), C4R(Colour.WHITE, 3, 2),
  C5R(Colour.WHITE, 4, 2), C6R(Colour.WHITE, 5, 2), C7R(Colour.WHITE, 6, 2), C8R(Colour.WHITE, 7, 2),
  D1R(Colour.WHITE, 0, 3), D2R(Colour.WHITE, 1, 3), D3R(Colour.WHITE, 2, 3), D4R(Colour.WHITE, 3, 3),
  D5R(Colour.WHITE, 4, 3), D6R(Colour.WHITE, 5, 3), D7R(Colour.WHITE, 6, 3), D8R(Colour.WHITE, 7, 3),
  E1R(Colour.WHITE, 0, 4), E2R(Colour.WHITE, 1, 4), E3R(Colour.WHITE, 2, 4), E4R(Colour.WHITE, 3, 4),
  E5R(Colour.WHITE, 4, 4), E6R(Colour.WHITE, 5, 4), E7R(Colour.WHITE, 6, 4), E8R(Colour.WHITE, 7, 4),
  F1R(Colour.WHITE, 0, 5), F2R(Colour.WHITE, 1, 5), F3R(Colour.WHITE, 2, 5), F4R(Colour.WHITE, 3, 5),
  F5R(Colour.WHITE, 4, 5), F6R(Colour.WHITE, 5, 5), F7R(Colour.WHITE, 6, 5), F8R(Colour.WHITE, 7, 5),
  G1R(Colour.WHITE, 0, 6), G2R(Colour.WHITE, 1, 6), G3R(Colour.WHITE, 2, 6), G4R(Colour.WHITE, 3, 6),
  G5R(Colour.WHITE, 4, 6), G6R(Colour.WHITE, 5, 6), G7R(Colour.WHITE, 6, 6), G8R(Colour.WHITE, 7, 6),
  H1R(Colour.WHITE, 0, 7), H2R(Colour.WHITE, 1, 7), H3R(Colour.WHITE, 2, 7), H4R(Colour.WHITE, 3, 7),
